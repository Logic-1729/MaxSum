              ...
              ** 
                 ...
                 assert (Hno_n: feasible_set done s').
                 {
                   ...
                   - exfalso. 
                     ...
                     { 
                       ...
                       - 
                         rewrite Heq_zero.
                         apply Hle_zero. exact Hfeas_prev. 
                     }
                     lia.
                 }
                 assert (Hidx_done: is_indexed_elements_nat done il' s').
                 {
                   ...
                   assert (Hi_range: 0 <= i < Zlength done).
                   {
                     split. 
                     - apply Znth_error_range in Hnth.  tauto.
                     - (* TODO: Prove indices in il' are bounded by Zlength done
                          Requires:   feasible_set done s' + is_indexed_elements_nat (done ++ [n]) il' s'
                          Implies:  all indices in il' are < Zlength done
                          Suggest extracting as Lemma feasible_indices_in_prefix *)
                       admit.
                   }
                   simpl in Hnth. 
